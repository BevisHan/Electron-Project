...
.controller('MainCtrl', ['$scope', '$luiDialog', '$ngTableFactory', '$resource', function ($scope, $luiDialog, $ngTableFactory, $resource) {
    ...
    function getDeviceConfig () {
        ...
        //let url = 'http://127.0.0.1:12315/Translayer/ClassroomTeaching.Authorization/api/DeviceConfig';
    ...
    function modifyClientConfig() {
        let path = '../SmartClassroom.Group/resources/config.json';
        if (fileExists(path)) {
